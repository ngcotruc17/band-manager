      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              className="w-full pl-12 pr-4 py-3.5 rounded-2xl border border-slate-200 bg-white shadow-sm focus:ring-2 ring-indigo-500 font-medium outline-none text-slate-800 transition"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredMembers.map((m) => (
              <div key={m._id} className="glass rounded-[32px] p-6 card-hover flex flex-col justify-between">
                <div>
