...
const CommentSection = ({ eventId }) => {
  ...
  const fetchComments = async () => {
    try {
      const res = await axios.get(`https://band-api.onrender.co/api/comments/${eventId}`, getHeaders());
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://band-api.onrender.co/api/comments', { content, eventId }, getHeaders());
  ...
  const handleDelete = async (commentId) => {
    ...
    try {
      await axios.delete(`https://band-api.onrender.co/api/comments/${commentId}`, getHeaders());
