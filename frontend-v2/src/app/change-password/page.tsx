...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errMsg = err.response?.data?.message || "Lỗi khi đổi mật khẩu";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#f8fafc] font-sans">
      ...
      <div className="relative w-full max-w-md bg-white/70 backdrop-blur-xl border border-white/50 rounded-[32px] p-8 sm:p-10 z-10 shadow-[0_30px_60px_rgba(15,23,42,0.08)] text-center">
